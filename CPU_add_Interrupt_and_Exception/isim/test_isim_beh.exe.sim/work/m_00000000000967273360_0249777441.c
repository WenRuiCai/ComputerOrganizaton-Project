...
#endif
static const char *ng0 = "E:/CPU Project/CPU_add_Interrupt_and_Exception/bridge.v";
...
LAB46:    memcpy(t193, t108, 8);

LAB47:    memset(t221, 0, 8);
    t222 = (t193 + 4);
...
LAB80:    if (*((unsigned int *)t222) != 0)
        goto LAB81;

LAB82:    t230 = *((unsigned int *)t32);
...
LAB33:    if (*((unsigned int *)t63) > *((unsigned int *)t62))
        goto LAB32;
...
LAB52:    if (*((unsigned int *)t122) < *((unsigned int *)t121))
        goto LAB51;

LAB50:    *((unsigned int *)t123) = 1;

LAB51:    memset(t127, 0, 8);
    t128 = (t123 + 4);
...
LAB58:    memcpy(t153, t127, 8);

LAB59:    memset(t185, 0, 8);
    t186 = (t153 + 4);
...
LAB73:    if (*((unsigned int *)t186) != 0)
        goto LAB74;

LAB75:    t194 = *((unsigned int *)t108);
...
LAB64:    if (*((unsigned int *)t140) > *((unsigned int *)t139))
        goto LAB63;

LAB62:    *((unsigned int *)t141) = 1;

LAB63:    memset(t145, 0, 8);
    t146 = (t141 + 4);
...
LAB83:    t241 = *((unsigned int *)t229);
    t242 = *((unsigned int *)t235);
    *((unsigned int *)t229) = (t241 | t242);
    t243 = (t32 + 4);
    t244 = (t221 + 4);
    t245 = *((unsigned int *)t32);
    t246 = (~(t245));
...
LAB30:    t107 = (t0 + 1208U);
    ...
    t111 = *((char **)t110);
    t112 = ((char*)((ng8)));
    xsi_vlog_generic_get_index_select_value(t109, 32, t108, t111, 2, t112, 32, 1);
    t113 = ((char*)((ng7)));
    memset(t114, 0, 8);
    t115 = (t109 + 4);
    t116 = (t113 + 4);
...
LAB34:    xsi_vlog_unsigned_bit_combine(t3, 32, t105, 32, t151, 32);
    goto LAB38;
...
LAB51:    xsi_vlog_unsigned_bit_combine(t105, 32, t141, 32, t146, 32);
    goto LAB55;

LAB53:    memcpy(t105, t141, 8);
    goto LAB55;
...
extern void work_m_00000000000967273360_0249777441_init()
{
	static char *pe[] = {(void *)Always_37_0,(void *)Cont_44_1,(void *)Cont_45_2,(void *)Cont_46_3,(void *)Cont_48_4,(void *)Cont_50_5};
	xsi_register_didat("work_m_00000000000967273360_0249777441", "isim/test_isim_beh.exe.sim/work/m_00000000000967273360_0249777441.didat");
