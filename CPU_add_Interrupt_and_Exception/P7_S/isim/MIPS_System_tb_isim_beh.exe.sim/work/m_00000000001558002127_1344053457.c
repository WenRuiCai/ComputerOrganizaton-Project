...
#endif
static const char *ng0 = "F:/ISE_project/P7_S/P7_S/EXC_DT_EX.v";
...
LAB35:    if (*((unsigned int *)t227) != 0)
        goto LAB36;

LAB37:    t234 = (t4 + 4);
    t235 = *((unsigned int *)t4);
    t236 = *((unsigned int *)t234);
    t237 = (t235 || t236);
    if (t237 > 0)
        goto LAB38;

LAB39:    t239 = *((unsigned int *)t4);
    t240 = (~(t239));
...
LAB41:    if (*((unsigned int *)t234) > 0)
        goto LAB42;

LAB43:    if (*((unsigned int *)t4) > 0)
        goto LAB44;

LAB45:    memcpy(t3, t243, 8);
...
LAB46:    t244 = (t0 + 1684);
    ...
    *((unsigned int *)t254) = (t256 | t250);
    xsi_driver_vfirst_trans(t244, 0, 4);
    t257 = (t0 + 1640);
    *((int *)t257) = 1;
...
LAB42:    xsi_vlog_unsigned_bit_combine(t3, 5, t238, 5, t243, 5);
    goto LAB46;

LAB44:    memcpy(t3, t238, 8);
    goto LAB46;

}


extern void work_m_00000000001558002127_1344053457_init()
{
	static char *pe[] = {(void *)Cont_34_0};
	xsi_register_didat("work_m_00000000001558002127_1344053457", "isim/MIPS_System_tb_isim_beh.exe.sim/work/m_00000000001558002127_1344053457.didat");
